import grpc
import numpy as np
import proto_generated.image_handler_pb2_grpc as image_handler_pb2_grpc
...
from common import make_proto_camera_frame
...
class GrpcClient(MiddlewareClient):
    def __init__(self, client_address):
        ...
        self._DataProcessorStub = image_handler_pb2_grpc.DataProcessorStub(self._DataProcessorChannel)
    ...
    def publish_shoulders_coordinates(self, left_shoulder_coord: detected_landmarks_pb2.Coordinates,
                                      right_shoulder_coord: detected_landmarks_pb2.Coordinates):
